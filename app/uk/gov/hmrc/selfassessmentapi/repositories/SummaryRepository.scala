...
trait SummaryRepository[T] {
  ...
  def create(saUtr: SaUtr,
             taxYear: TaxYear,
             sourceId: SourceId,
             summary: T): Future[Option[SummaryId]]
  ...
  def update(saUtr: SaUtr,
             ...
             sourceId: SourceId,
             id: SummaryId,
             summary: T): Future[Boolean]

  def delete(saUtr: SaUtr,
             taxYear: TaxYear,
             sourceId: SourceId,
             id: SummaryId): Future[Boolean]

  def list(saUtr: SaUtr,
           taxYear: TaxYear,
           sourceId: SourceId): Future[Option[Seq[T]]]

  def listAsJsonItem(saUtr: SaUtr,
                     taxYear: TaxYear,
                     sourceId: SourceId): Future[Seq[JsonItem]]
}

case class SummaryRepositoryWrapper[T](
    private val target: SummaryRepository[T])
    extends SummaryRepository[T] {
  ...
  override def create(saUtr: SaUtr,
                      taxYear: TaxYear,
                      sourceId: SourceId,
                      income: T): Future[Option[SummaryId]] = {
