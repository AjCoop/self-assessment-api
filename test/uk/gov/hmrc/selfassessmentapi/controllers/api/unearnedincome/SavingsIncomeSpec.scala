...
class SavingsIncomeSpec extends JsonSpec {
  ...
  "format" should {
    ...
    "round trip valid SavingsIncome json" in {
      roundTripJson(
        SavingsIncome(`type` = InterestFromBanksTaxed,
  ...
  "validate" should {
    "reject amounts with more than 2 decimal values" in {
      Seq(BigDecimal(1000.123),
        ...
        assertValidationError[SavingsIncome](
          ...
          "Expected invalid savings-income with more than 2 decimal places")
      }
    }
    ...
    "reject invalid SavingsIncome type" in {
      ...
      assertValidationError[SavingsIncome](json,
                                           Map("/type" -> NO_VALUE_FOUND),
                                           "should fail with invalid type")
    }

    "reject negative amount" in {
      val seIncome = SavingsIncome(`type` = InterestFromBanksTaxed,
