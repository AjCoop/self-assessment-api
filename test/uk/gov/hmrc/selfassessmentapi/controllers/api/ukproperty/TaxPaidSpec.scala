    ...
    "reject amounts with more than 2 decimal values" in {
      Seq(BigDecimal(1000.123),
        ...
        assertValidationError[TaxPaid](
          ...
          "Expected invalid uk-property-tax-paid with more than 2 decimal places")
      }
    }

    "reject negative amount" in {
      assertValidationError[TaxPaid](TaxPaid(amount = BigDecimal(-1000.13)),
                                     Map("/amount" -> INVALID_MONETARY_AMOUNT),
                                     "Expected negative uk-property-tax-paid")
    }
  }
}
